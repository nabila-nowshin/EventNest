    ...
    return (
        <div className='bg-gradient-to-br from-[#acb8e4] to-[#9bb6f1] my-20'>
            ...
            <div id="slide1" className="carousel-item relative w-full flex flex-col lg:flex-row items-center h-[400px] ">
                ...
                className="w-full lg:w-1/2 object-cover h-full"
                />
                <div className="lg:w-1/2 bg-[#000118]/80 text-white p-8 lg:p-16 h-full">
                    <h2 className="text-4xl font-bold mb-4 text-[#52faca]">TechXpo 2025</h2>
                    <p className="text-lg text-gray-300 leading-relaxed">
                        Explore the future of AI, Robotics, and IoT with top innovators and tech giants at TechXpo 2025.
                    </p>
                    <button className="mt-6 px-6 py-2 bg-[#52faca] text-black rounded-full hover:bg-[#3cdab0] transition-all duration-300">
                        Explore More
                    </button>
                </div>
            ...
            {/* Slide 2 */}
            <div id="slide2" className="carousel-item relative w-full flex flex-col lg:flex-row items-center h-[400px]">
                <img
                src="https://i.ibb.co/Fq0scmYv/img2.jpg"
                className="w-full lg:w-1/2 object-cover h-full"
                />
                <div className="lg:w-1/2 bg-[#000118]/80 text-white p-8 lg:p-16 h-full">
                    <h2 className="text-4xl font-bold mb-4 text-[#52faca]">Foodie Fiesta</h2>
                    <p className="text-lg text-gray-300 leading-relaxed">
            ...
            {/* Slide 3 */}
            <div id="slide3" className="carousel-item relative w-full flex flex-col lg:flex-row items-center h-[400px]">
                <img
                src="https://i.ibb.co/Pskswp3t/img3.jpg"
                className="w-full lg:w-1/2 object-cover h-full"
                />
                <div className="lg:w-1/2 bg-[#000118]/80 text-white p-8 lg:p-16 h-full">
                    <h2 className="text-4xl font-bold mb-4 text-[#52faca]">Creative Minds Art Fair</h2>
                    <p className="text-lg text-gray-300 leading-relaxed">
            ...
            {/* Slide 4 */}
            <div id="slide4" className="carousel-item relative w-full flex flex-col lg:flex-row items-stretch h-[400px]">
                <img
                src="https://i.ibb.co/qF0xnKXZ/img5.jpg"className="w-full lg:w-1/2 object-cover h-full"
                />
                <div className="lg:w-1/2 bg-[#000118]/80 text-white p-8 lg:p-16 h-full ">
                <h2 className="text-4xl font-bold mb-4 text-[#52faca]">Sunset Music Bash</h2>
                <p className="text-lg text-gray-300 leading-relaxed">
